...
node_keys = {
    name: {
        "publicKey": os.getenv(f"PY_TESTNET_NEUROWEB_{name.replace(' ', '_').upper()}_PUBLIC_KEY"),
        "privateKey": os.getenv(f"PY_TESTNET_NEUROWEB_{name.replace(' ', '_').upper()}_PRIVATE_KEY"),
    }
